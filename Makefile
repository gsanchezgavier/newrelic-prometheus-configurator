...
release-changelog: _release-changes
	...
	$(RT_BIN) update-changelog --markdown CHANGELOG.md --version $$VER
	@git --no-pager diff CHANGELOG.md

### Ptrints out the Release Notes as if a Release is being triggered.
.PHONY: _release-changes
_release-changes:
	@$(RT_BIN) validate
	@$(RT_BIN) generate --excluded-dirs "charts,.github" --tag-prefix "v"
